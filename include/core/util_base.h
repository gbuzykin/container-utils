...
struct is_alloc_always_equal : std::false_type {};
...
struct get_n {
    template<typename Ty>
    auto operator()(Ty&& v) const -> decltype(impl::get_n<Ty, n, Func1, Func2>(std::forward<Ty>(v))) {
        return impl::get_n<Ty, n, Func1, Func2>(std::forward<Ty>(v));
    }
};
...
struct key {
    template<typename Ty>
    auto operator()(Ty&& v) const -> decltype(impl::get_key(std::forward<Ty>(v))) {
        return impl::get_key(std::forward<Ty>(v));
    }
};
