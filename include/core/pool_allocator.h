...
class CORE_EXPORT pool_base {
 public:
    ...
    bool operator==(const pool_base& other) const NOEXCEPT { return desc_->root_pool == other.desc_->root_pool; }
...
class pool_allocator {
 ...
 public:
    ...
    template<typename Ty2>
    bool operator==(const pool_allocator<Ty2>& other) const NOEXCEPT {
...
class global_pool_allocator {
 ...
 public:
    ...
    template<typename Ty2>
    bool operator==(const global_pool_allocator<Ty2>&) const NOEXCEPT {
        return true;
    }
    template<typename Ty2>
    bool operator!=(const global_pool_allocator<Ty2>& other) const NOEXCEPT {
        return !(*this == other);
    }
};
