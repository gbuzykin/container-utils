...
class rbtree_compare<NodeTy, Alloc, Comp,
 ...
 public:
    rbtree_compare() NOEXCEPT_IF(std::is_nothrow_default_constructible<alloc_type>::value) {}
...
class rbtree_base : protected rbtree_compare<NodeTy, Alloc, Comp> {
 ...
 public:
    ...
    rbtree_base() NOEXCEPT_IF((std::is_nothrow_default_constructible<key_compare>::value) &&
                              (std::is_nothrow_default_constructible<allocator_type>::value)) {
        init();
    }
    explicit rbtree_base(const allocator_type& alloc)
 ...
 protected:
    ...
    static rbtree_node_t* to_ptr(const_iterator it, const rbtree_base& t) { return it.node(std::addressof(t.head_)); }
